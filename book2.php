...
if (!$conn) {
	die("Could not connect ".mysqli_error());
       ...
       $query="INSERT INTO booking2(user,Flight_Id,Seats,Total_fare,Bank,Payment_method)VALUES('".$_SESSION['e-mail']."','".$_SESSION['Flight_id']."','".$_SESSION['traveller']."','".$_SESSION['Total_Fare']."','".$_POST['Bank']."','".$_POST['Payment_method']."')";
...
if (!$conn) {
	die("Could not connect ".mysqli_error());
            ...
            $req=$_SESSION['traveller'];
            $id = $_SESSION['Flight_id'];

            $query= "UPDATE flight SET Seats=(Seats-$req) WHERE FlightId=$id";
			if(mysqli_query($conn,$query))
           	 { 
