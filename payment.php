...
?>
  ...
  <input class="w3-input w3-border w3-round" name="email" type="email" placeholder="Enter Card number" style="width: 50%; border-radius: 9px;">
       
        <br>
        
  <label style="float: left;">Card holder name</label>
  <input class="w3-input w3-border w3-round" name="email" type="email" placeholder="Enter Card holder name" style="width: 50%; border-radius: 9px;">
