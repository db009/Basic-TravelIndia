   ...
   <hr style="color:red">                                   </hr>
       <center>
    	<div class="form-train">
         <h2> <i class="fa fa-subway" style="font-size:30px;color:#3383FF"></i> &nbsp; Train Booking </h2>
         <form class="form-inline" action="trainaction.php" method="POST" autocomplete="off">
  ...
  &nbsp; &nbsp;       <label for="Class" style="margin-left: 2%">Class: </label>
        ...
        <br>
                               <tr>
                                ...
                                <td   valign="middle" align="left">
                                    Adults (above 12):-
                                    <select type="number" required="required"  id="enq_traveller_adult" name="traveller_adult">
                                ...
                                <td   valign="middle" align="left">
                                    Childrens (2-12):-
                                    <select type="number" required="required" class="" id="enq_traveller_child" name="traveller_child">
										<option value="0">--select--</option>
								...
								<button class="button">Search Trains</button>
