...
if (!$conn) {
	die("Could not connect ".mysqli_error());
       ...
       $query="INSERT INTO booking1(user,Train_Id,Train_No,Seats,Total_fare,Bank,Payment_method)VALUES('".$_SESSION['e-mail']."','".$_SESSION['Train_id']."','".$_SESSION['Train_no']."','".$_SESSION['travellers']."','".$_SESSION['total_fare']."','".$_POST['Bank']."','".$_POST['Payment_method']."')";
...
if (!$conn) {
	die("Could not connect ".mysqli_error());
            ...
            $query= "UPDATE train SET Seats=(Seats-$req) WHERE TrainId=$id";
			if(mysqli_query($conn,$query))
           	 { 
